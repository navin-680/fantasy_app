...
class BowlerListWidget extends StatefulWidget {
  const BowlerListWidget({super.key});

  @override
  State<BowlerListWidget> createState() => _BowlerListWidgetState();
}

class _BowlerListWidgetState extends State<BowlerListWidget> {
